...
const EmailVerification2: React.FC = () => {
          ...
          <div className="login-content">
            <div className="login-userset">
              ...
              <div className="login-userheading">
                <h3>{t('auth.email_verification_2')}</h3>
              ...
              <form>
                ...
                <div className="form-login">
                  <button type="submit" className="btn btn-primary w-100">{t('auth.email_verification_2')}</button>
                </div>
              </form>
