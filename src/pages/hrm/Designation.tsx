...
const Designation: React.FC = () => {
  ...
  const confirmDelete = async () => {
    if (!deleteId) return;
    try { await deleteDesignation(deleteId); setShowDeleteModal(false); setDeleteId(null); showSuccess(t('hrm.designation_deleted')); loadData(); }
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content p-5">
              <div className="modal-body text-center p-0">
                ...
                <h4>{t('hrm.delete_designation')}</h4><p className="text-muted">{t('hrm.confirm_delete_designation')}</p>
